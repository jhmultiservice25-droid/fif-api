...
exports.JOBS = [
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Appuyer le Coordonnateur général dans le pilotage opérationnel du Festival, l’alignement des pôles et la tenue du calendrier jusqu’aux 13–15 octobre 2026.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Assister le Coordonnateur général adjoint dans le suivi quotidien, la logistique de coordination et la préparation des instances de décision.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Concevoir et livrer le programme des 14 et 15 octobre : plénières, FIKIRI Talks, Academy, challenges, Demo Show et Grand Pitch.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Gérer la relation speakers, les briefs et la logistique des interventions sur les scènes FIF.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Organiser les masterclasses du Jour 2 (startup, IA, cybersécurité, MVP, pitch, financement, marque personnelle, data & langues congolaises).",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Faire du FIKIRI Village le lieu où 100+ solutions sont exposées, démontrées et mises en relation avec les décideurs.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Suivre le pipeline exposants, les dossiers d’inscription et l’accompagnement jusqu’à l’installation.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Animer la zone de démonstration, le rythme des démos et l’expérience visiteur du Village.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Piloter le Buyers Programme : exprimer les besoins, identifier les solutions locales, organiser les rendez-vous B2B et viser des pilotes.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Opérer l’agenda B2B, les outils de matching et l’accueil des buyers pendant le Festival.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Sécuriser les partenariats institutionnels, privés et techniques nécessaires au Festival et à son après.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Appuyer le suivi des dossiers partenaires, des contreparties et de la documentation contractuelle.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Porter le récit public du FIF 2026, la couverture médiatique et la présence digitale avant, pendant et après le Festival.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Produire et orchestrer les contenus digitaux, le community management et la couverture en temps réel.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Gérer les relations presse, l’accueil médias et les kits de communication.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Mobiliser les 2 000+ participants et constituer, former et encadrer le corps des 80 à 100 volontaires FIF 2026.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Opérer le recrutement, l’affectation, les shifts et le suivi quotidien des volontaires.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Livrer le site, la production technique, la signalétique et les flux pour un festival de 2 000+ personnes.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Suivre le matériel, les équipes terrain et l’exécution du plan d’installation.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Garantir les plateformes FIF, la connectivité, les badges/QR, l’audiovisuel numérique et les expériences immersives.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Opérer le support numérique, les badges, la connectivité et l’assistance aux scènes et stands.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Garantir l’accueil des autorités, le respect du protocole, la sécurité des personnes et le parcours VIP.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Exécuter les parcours d’accueil VIP, le briefing des équipes et le suivi des invités sur site.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "LEAD",
        headcount: 1,
        mission: "Tenir le système de planification du Comité : jalons, risques, reporting et aide à la décision.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Assurer le secrétariat du Comité : convocations, archives, notes et assistance à la coordination.",
        responsibilities: [
    ...
    },
    {
        ...
        roleKind: "DEPUTY",
        headcount: 1,
        mission: "Collecter les indicateurs, alimenter les tableaux de bord et préparer les synthèses de pilotage.",
        responsibilities: [
